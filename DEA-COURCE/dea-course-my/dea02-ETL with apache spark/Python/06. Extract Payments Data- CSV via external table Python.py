...
df = (
        spark.read.format("csv")
            ...
            .load("abfss://gizmobox-new@deacourseextdl3.dfs.core.windows.net/landing/external_data/payments/")
    )
display(df)
...
# MAGIC %sql
# MAGIC select * from `gizmobox-new`.bronze.payments
...
df.writeTo("`gizmobox-new`.bronze.py_payments").createOrReplace()

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from `gizmobox-new`.bronze.py_payments

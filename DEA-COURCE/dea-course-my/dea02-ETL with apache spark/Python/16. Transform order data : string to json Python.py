...
# MAGIC %sql
# MAGIC SELECT * 
# MAGIC FROM `gizmobox-new`.bronze.py_orders;
# MAGIC

# COMMAND ----------

df_orders = spark.table("`gizmobox-new`.bronze.py_orders")
display(df_orders)
...
df_json_orders.writeTo("`gizmobox-new`.silver.py_orders_json").createOrReplace()

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from `gizmobox-new`.silver.py_orders_json
